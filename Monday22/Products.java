...
public static void info(String prd_name,int price1){
	...
	if(prd_name=="Laptop"){
		System.out.println(prd_name+"Product discount is 20%");
	}
...
public static void collection(String prd_name3,int price3){
	...
	if(prd_name3=="Chair"){
		System.out.println(prd_name3+"Product discount is 4%");
	}
...
public static void pen(String prd_name5,int price5){
	...
	if(prd_name5=="Pen"){
		System.out.println(prd_name5+"Product discount is 0.1%:");
	}
...
public static void information(String prd_name7,int price6){
	System.out.println("product name is :"+prd_name7);
	System.out.println("Price is :"+price6);
	int dis_prd6=30;
	int price_to_value5=dis_prd6%100*dis_prd6;
	double no_disc_price5=price6-price_to_value5;
	if(prd_name7=="Cloth"){
		System.out.println(prd_name7+"Product discount is 30%:");
	}
